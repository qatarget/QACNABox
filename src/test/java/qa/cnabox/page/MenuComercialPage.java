...
public class MenuComercialPage extends BasePage {
	...
	{
		clicarBotaoBy(By.xpath("//div[@id='menu-lateral']/ul[@class='nav-left-bar']/li[6]/ul[@class='sub-menu']//span[.='Atendimento']"));		
	}
	...
	public void SetRolarAPagina(String rolarPagina) {
		
		((JavascriptExecutor) getDriver()).executeScript(rolarPagina);
	}
	...
	public void SetSelecionarEstagio(String estagio) {
	...
	public void SetSelecionarHorario() {
		clicarBotaoBy(By.xpath("/html//table[@id='datatable_tabletools']/tbody/tr[1]/td[2]/label[@class='checkbox']/i"));
		clicarBotaoBy(By.xpath("/html//table[@id='datatable_tabletools']/tbody/tr[1]/td[3]/label[@class='checkbox']/i"));
		clicarBotaoBy(By.xpath("/html//table[@id='datatable_tabletools']/tbody/tr[1]/td[7]/label[@class='checkbox']/i"));		
	}
	
	public void SetEscreveCPF() {
		escreveId("CPF_CNPJ", geracpf(true));
	}
