...
public class TesteLogin {
	...
	public void inicializa() {
		...
		driver.get("https://teste.cnabox.com.br");	
		dsl = new DSL(driver);
		page = new CnaBoxPage(driver);
	}
	...
	public void DeveRealizarLogin() {
		...
		//dsl.escreverNomeEscola("select2-search__field", "ADMINISTRACAO NACIONAL CNA");
		//driver.findElement(By.className("select2-search__field")).sendKeys("ADMINISTRACAO NACIONAL CNA");
